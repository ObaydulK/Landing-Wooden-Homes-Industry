      ...
      <div class="-mx-4 flex flex-wrap justify-between">
        <div class="px-4 my-4 w-full xl:w-1/5">
          <a href="/" class="block w-56 mb-10">
             <img src="https://i.ibb.co.com/JW9N5CQ0/Whats-App-Image-2025-02-16-at-12-18-27-PM.jpg" alt="Logo">
          </a>
          <div class="px-4 my-4 w-full flex gap-2 sm:w-auto xl:w-1/5">
        ...
        <div class="px-4 my-4 w-full sm:w-auto">
          <div>
            <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Explore</h2>
          </div>
          <ul class="leading-8">
            <li><a href="#" class="hover:text-blue-400">Home</a></li>
            <li><a href="#" class="hover:text-blue-400">About Us</a></li>
            <li><a href="#" class="hover:text-blue-400">Our Project</a></li>
    ...
    <div class="container mx-auto px-4">
      <div class="-mx-4 flex justify-center">
        <div class="px-4 w-full text-center sm:w-auto sm:text-left">
          ...
          <script>new Date().getFullYear() > 2020 && document.write("@" + new Date().getFullYear())</script>. Landing Wooden Homes Industry. All Rights Reserved.
